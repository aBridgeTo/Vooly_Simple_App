...
import com.example.voolysimpleapp.adpters.ListViewAdapter;
...
public class VollyPojo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_volly_pojo);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ListViewAdapter adapter = new ListViewAdapter(getApplicationContext(),heroList);
